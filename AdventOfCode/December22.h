...
namespace December22 {
    ...
    public:
        InfectedGrid();
        InfectedGrid(const std::string& fileName);
        ~InfectedGrid() = default;
    ...
    public:
        Matrix::CharMatrix GetMatrix() const { return m_matrix; }
        Coord::Point GetVirusPosition() const { return m_virusPosition; }
